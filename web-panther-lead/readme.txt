=== Wep Panther Lead ===
Contributors: somanbandesha
Tags: web panther
Donate link: https://somanbandesha.netlify.app/
...
yes its easy to install and use
Yes its worked with elementor form


== Screenshots ==
1. How to get API link
2. Shortcode For Elementor Form
3. Result API Link
